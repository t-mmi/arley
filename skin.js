...
// Filename: simplex_info.ggsk
// Generated Tue May 12 15:41:13 2015
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._text_1.ggTextDiv.innerHTML="<b>Arley Hall was built for Rowland Egerton-Warburton between 1832 & 1845<\/b>";
		...
		this._text_2.ggTextDiv.innerHTML="<b>The main entrance to the grounds is through an arch which is the 19th Century Clock Tower<\/b>";
		...
		this._text_3.ggTextDiv.innerHTML="<b>The Drawing Room is also used for Wedding Ceremonies<\/b>";
		this._text_3.appendChild(this._text_3__text);
		this._text_3.onclick=function () {
			flag=(me._text_3.style.visibility=='hidden');
			me._text_3.style[domTransition]='none';
			me._text_3.style.visibility=flag?'inherit':'hidden';
			me._text_3.ggVisible=flag;
		}
		...
		this._text_4.ggTextDiv.innerHTML="<b>Welcome to the Emporer Room where Napoleon III stayed<\/b>";
		this._text_4.appendChild(this._text_4__text);
		this._text_4.onclick=function () {
			flag=(me._text_4.style.visibility=='hidden');
			me._text_4.style[domTransition]='none';
			me._text_4.style.visibility=flag?'inherit':'hidden';
			me._text_4.ggVisible=flag;
		}
		this.divSkin.appendChild(this._text_4);
		...
		this._text_5.ggTextDiv.innerHTML="<b>The Gallery Room is also used for Wedding Breakfasts<\/b>";
		this._text_5.appendChild(this._text_5__text);
		this._text_5.onclick=function () {
			flag=(me._text_5.style.visibility=='hidden');
			me._text_5.style[domTransition]='none';
			me._text_5.style.visibility=flag?'inherit':'hidden';
			me._text_5.ggVisible=flag;
		}
		this.divSkin.appendChild(this._text_5);
